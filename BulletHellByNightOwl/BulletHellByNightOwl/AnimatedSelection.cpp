...
AnimatedSelection::AnimatedSelection(string fileName, int row, int column) : GameObject(NONE)
{
	addSprite(fileName, row, column);
}


void AnimatedSelection::addSprite(string fileName, int row, int column)
{
...
void AnimatedSelection::update(float deltaTime)
{
	timeCount += deltaTime;
...
void AnimatedSelection::setColumn(int c)
{
	this->column = c;
}

int AnimatedSelection::getRow()
{
	return this->row;
}

int AnimatedSelection::getColumn()
{
	return this->column;
}

void AnimatedSelection::genUV()
{
...
void AnimatedSelection::loopUV(float deltaTime)
{
...
void AnimatedSelection::setAnimationLoop(int row, int column, int loop, int time)
{
	this->animRow = row;
...
void AnimatedSelection::nextAnimation()
{
	loopCount++;
